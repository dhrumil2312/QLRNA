...
import os
import rna_toolkit
from Stacking_Assignment import RL_Stacking
from UBP_type_1_Assignment import RL_UBP_1
from UBP_type_2_Assignment import RL_UBP_2
from UBP_type_3_Assignment import RL_UBP_3
from UBP_type_4_Assignment import RL_UBP_4
from UBP_type_5_Assignment import RL_UBP_5
from UBP_type_6_Assignment import RL_UBP_6
import Extract_UBP
import random
...
def qlrna(dp_temp):
    ...
    bp_raw = rna_toolkit.dp_to_bp(dp)
    bp_array = np.array(bp_raw) - 1            # 0 is first position. -1 is unpaired.
    check_array = rna_toolkit.structure_analysis(bp_raw)
