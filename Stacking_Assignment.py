from stacking_env import Stacking
...
with open(r"stacking_q_learning_q_table_A_U.pickle", 'rb') as ff:
    q_table_A_U = pickle.load(ff)
with open('stacking_q_learning_q_table_C_G.pickle', 'rb') as ff:
    q_table_C_G = pickle.load(ff)
with open('stacking_q_learning_q_table_G_C.pickle', 'rb') as ff:
    q_table_G_C = pickle.load(ff)
with open('stacking_q_learning_q_table_G_U.pickle', 'rb') as ff:
    q_table_G_U = pickle.load(ff)
with open('stacking_q_learning_q_table_U_A.pickle', 'rb') as ff:
    q_table_U_A = pickle.load(ff)
with open('stacking_q_learning_q_table_U_G.pickle', 'rb') as ff:
